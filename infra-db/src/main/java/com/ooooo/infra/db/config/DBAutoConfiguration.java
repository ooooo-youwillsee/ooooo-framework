package com.ooooo.infra.db.config;
...
import com.ooooo.infra.db.datasource.MultiDataSourceAdvisor;
import com.ooooo.infra.db.datasource.MultiDataSourceProperties;
import com.ooooo.infra.db.datasource.MultiRoutingDataSource;
import com.ooooo.infra.db.mybatis.CheckMaxRowsInterceptor;
import com.ooooo.infra.db.mybatis.TimeMetaObjectHandler;
...
import static com.ooooo.infra.db.config.DBProperties.ENABLE_MULTI_DATA_SOURCE;
...
//    }
  ...
  @ConditionalOnProperty(prefix = DBProperties.OOOOO_DB, name = ENABLE_MULTI_DATA_SOURCE,
